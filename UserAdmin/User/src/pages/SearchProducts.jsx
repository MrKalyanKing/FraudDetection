...
import { Search, Filter, Star, ShoppingCart, Plus, CheckCircle } from 'lucide-react';
            ...
            >
              ...
              <div style={{
                ...
                background: `linear-gradient(135deg, ${
                  product.category === 'electronics' ? '#667eea, #764ba2' :
                  product.category === 'clothing' ? '#f093fb, #f5576c' :
                  product.category === 'books' ? '#4facfe, #00f2fe' :
                  product.category === 'home' ? '#43e97b, #38f9d7' :
                  '#ffecd2, #fcb69f'
                })`,
                display: 'flex',
                alignItems: 'center',
